...
FileActionAttributes::FileActionAttributes(bool time_based, DataSize<DataUnit::B> block_size,
...
std::chrono::seconds FileActionAttributes::get_time_limit() const { return m_time_limit; }
...
VirtualMonitoredAction::VirtualMonitoredAction(std::chrono::milliseconds monitoring_interval,
...
VirtualMonitoredAction::get_monitored_data() {
  return m_monitoredData;
}
std::chrono::nanoseconds VirtualMonitoredAction::get_monitor_started_at() {
  return m_monitor_started_at;
}
